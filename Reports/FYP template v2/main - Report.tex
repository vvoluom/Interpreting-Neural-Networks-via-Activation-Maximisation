...
\begin{tabular}{|l|l|l|l|l}
\cline{1-4}
Macro-Average &  0.224307240171471 & 0.217997464918668 &	0.211318197480614 \\ \cline{1-4}
Micro-Average & 0.597438470798491 &	0.587057612307554 &	0.574165491068433\\ \cline{1-4}
Example & 0.276187992679944 & 0.271005522147088 & 0.264707157074801\\ \cline{1-4}
\caption{Fine-Tuned VGG16 on VRD dataset Example and Micro/Macro Average Label Based Metrics}
\end{tabular}

\subsubsection{SmallVGG Evaluation Results}
...
\subsubsection{SpatialVoc2k Dataset Evaluation Results}
